...
import 'package:doctor_apps/features/home/home_view.dart' as _i2;
import 'package:doctor_apps/features/patient/patient_detail_view.dart' as _i6;
import 'package:doctor_apps/features/patient/patient_form_view.dart' as _i4;
import 'package:doctor_apps/features/patient/patient_list_view.dart' as _i5;
import 'package:doctor_apps/features/startup/startup_view.dart' as _i3;
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      ...
      page: _i5.PatientListView,
    ),
    _i1.RouteDef(
      Routes.patientDetailView,
      page: _i6.PatientDetailView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i5.PatientListView: (data) {
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) => const _i5.PatientListView(),
        settings: data,
      );
    },
    _i6.PatientDetailView: (data) {
      final args = data.getArgs<PatientDetailViewArguments>(nullOk: false);
      return _i7.MaterialPageRoute<dynamic>(
        builder: (context) =>
            _i6.PatientDetailView(key: args.key, patientId: args.patientId),
        settings: data,
      );
    },
  };
